                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div>
                            <Card className="p-4 bg-blue-50 rounded-lg sticky top-8">
                                ...
                                : "Mức lương: Thương lượng"}</span></div>                                <div className="text-sm text-gray-600 dark:text-gray-300 mb-4">Ngày hết hạn: {job.expires_at ? new Date(job.expires_at).toLocaleDateString('vi-VN') : 'N/A'}</div>
                                {isAuthenticated ? (
