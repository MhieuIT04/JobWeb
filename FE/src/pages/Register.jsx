            ...
            <div className="container max-w-md mx-auto pt-8 pb-8">
                <Card className="p-6 sm:p-8 shadow-lg bg-white/95 dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-blue-300">Đăng ký tài khoản</h1>                        <form onSubmit={handleSubmit} className="w-full space-y-4">
                            {error && (
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-4">
                                    <label className="flex items-center gap-2 text-gray-700 dark:text-blue-200">                                        <input
                                            type="radio"
                                            name="role"
                                            value="candidate"
                            ...
                            <Button
                                type="submit"
                                className="w-full py-6 text-lg font-bold bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600"                                disabled={loading}
                            >
                                {loading ? 'Đang xử lý...' : 'Đăng ký'}
                            </Button>
                            <p className="text-center text-sm text-gray-700 dark:text-blue-200">
                                Đã có tài khoản?{' '}
                                <RouterLink to="/login" className="font-semibold text-blue-600 dark:text-blue-400 hover:underline">                                    Đăng nhập
                                </RouterLink>
                            </p>
                        </form>
                    </div>
