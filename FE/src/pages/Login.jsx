            ...
            <div className="container max-w-md mx-auto pt-8 pb-8">
                <Card className="p-6 sm:p-8 shadow-lg bg-white/95 dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-blue-300">                            Đăng nhập
                        </h1>
                        <form onSubmit={handleSubmit} className="w-full space-y-4">
                            ...
                            <p className="text-center text-sm text-gray-700 dark:text-blue-200">
                                Chưa có tài khoản?{' '}
                                <RouterLink to="/register" className="font-semibold text-blue-600 dark:text-blue-400 hover:underline">                                    Đăng ký ngay
                                </RouterLink>
                            </p>
                        </form>
                    </div>
