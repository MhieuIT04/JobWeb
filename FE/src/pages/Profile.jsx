        ...
        <Card className="p-6 max-w-2xl mx-auto bg-white/95 dark:bg-gray-900 rounded-xl shadow-lg border-gray-200 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex flex-col items-center mb-4">
                    ...
                    <Button asChild variant="outline" className="mb-2 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-blue-300 hover:bg-gray-100 dark:hover:bg-gray-800"><label>
                ...
                {user?.role === 'employer' && (
                    <div className="flex flex-col items-center mb-4 border border-dashed border-blue-300 dark:border-blue-600 p-4 rounded bg-blue-50 dark:bg-gray-800">
                        ...
                        <Button asChild variant="outline" className="border-gray-300 dark:border-gray-600 text-gray-900 dark:text-blue-300 hover:bg-gray-100 dark:hover:bg-gray-800"><label>
                                Thay đổi Logo
                ...
                <Button type="submit" className="w-full py-3 text-lg font-bold bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600" disabled={isSaving}>                    {isSaving ? 'Đang xử lý...' : 'Lưu thay đổi'}
                </Button>
            </form>
        </Card>
        </div>
